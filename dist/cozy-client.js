...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 6:
	            ...
	            _context.next = 9;
	            return defineIndexV1(config, doctype, fields);
	      ...
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          ...
	          case 5:
	            ...
	            _context2.next = 8;
	            return queryV1(config, indexRef, options);
	...
	var defineIndexV1 = function () {
	  ...
	  return function defineIndexV1(_x5, _x6, _x7) {
	    return _ref3.apply(this, arguments);
	  };
	}();
	...
	var defineIndexV2 = function () {
	  ...
	  return function defineIndexV2(_x8, _x9, _x10) {
	    return _ref4.apply(this, arguments);
	  };
	}();
	...
	var queryV1 = function () {
	    ...
	    return regeneratorRuntime.wrap(function _callee5$(_context5) {
	      while (1) {
	        switch (_context5.prev = _context5.next) {
	          ...
	          case 2:
	            if (options.fields) {
	              (0, _utils.warn)('query fields will be ignored on v1');
	            }
	  ...
	  return function queryV1(_x11, _x12, _x13) {
	    return _ref5.apply(this, arguments);
	  };
	}();
	...
	var queryV2 = function () {
	  ...
	  return function queryV2(_x14, _x15, _x16) {
